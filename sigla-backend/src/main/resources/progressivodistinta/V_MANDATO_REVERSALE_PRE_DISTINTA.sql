-- SIGLA.V_MANDATO_REVERSALE_PRE source

CREATE OR REPLACE FORCE EDITIONABLE VIEW "SIGLA"."V_MANDATO_REVERSALE_PRE" ("CD_TIPO_DOCUMENTO_CONT", "CD_CDS", "ESERCIZIO", "PG_DOCUMENTO_CONT", "CD_UNITA_ORGANIZZATIVA", "CD_CDS_ORIGINE", "CD_UO_ORIGINE", "TI_DOCUMENTO_CONT", "DS_DOCUMENTO_CONT", "STATO", "STATO_TRASMISSIONE", "DT_EMISSIONE", "DT_TRASMISSIONE", "DT_RITRASMISSIONE", "DT_PAGAMENTO_INCASSO", "DT_ANNULLAMENTO", "IM_DOCUMENTO_CONT", "IM_RITENUTE", "IM_PAGATO_INCASSATO", "CD_TERZO", "CD_TIPO_DOCUMENTO_CONT_PADRE", "PG_DOCUMENTO_CONT_PADRE", "TI_DOCUMENTO_CONT_PADRE", "PG_VER_REC", "DT_FIRMA", "TIPO_DEBITO_SIOPE", "ESITO_OPERAZIONE", "STATO_VAR_SOS", "SELEZIONE_TESORERIA", "PG_DISTINTA_TESORERIA") AS
SELECT
    ...
    a.esito_operazione,
    a.stato_var_sos,
    a.selezione_tesoreria,
    a.pg_distinta_tesoreria
