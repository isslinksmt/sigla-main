...
public class Numerazione_baseComponentSessionBean extends it.cnr.jada.ejb.GenericComponentSessionBean implements Numerazione_baseComponentSession {
	...
	public java.lang.Long creaNuovoProgressivoOffset(it.cnr.jada.UserContext param0,java.lang.Integer param1,java.lang.String param2,java.lang.String param3,java.lang.String param4, Integer param5) throws it.cnr.jada.comp.ComponentException,it.cnr.jada.bulk.BusyResourceException,javax.ejb.EJBException {
		pre_component_invocation(param0,componentObj);
		try {
			java.lang.Long result = componentObj.creaNuovoProgressivoOffset(param0,param1,param2,param3,param4, param5);
			component_invocation_succes(param0,componentObj);
			return result;
		} catch(it.cnr.jada.comp.NoRollbackException e) {
			component_invocation_succes(param0,componentObj);
