...
public interface DistintaCassiereComponentSession extends it.cnr.jada.ejb.CRUDDetailComponentSession {
    ...
    it.cnr.contab.doccont00.intcass.bulk.Distinta_cassiereBulk calcolaMinProgressivoManRev(it.cnr.jada.UserContext param0, it.cnr.contab.doccont00.intcass.bulk.Distinta_cassiereBulk param1) throws it.cnr.jada.comp.ComponentException, java.rmi.RemoteException;
