...
public class CaricaFileMandatoBP extends BulkBP {
    ...
    private List<MandatiReversaliParsedDto> parseRecords(List<String[]> records, UserContext userContext) throws ComponentException, RemoteException {
        ...
        for (String[] record : records) {
            ...
            try {
                mandatoReversaleBulk = mandatoComponentSession.getMandatoReversaleBulkByPgDisintaTesoreria(userContext,configurazioneTesoreriaCodiceEnte.get(codiceEnte), pgDistintaTesoreria.toString(), esercizio.toString(), "MAN");
